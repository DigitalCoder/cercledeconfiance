...
class User
{
     ...
     * @var string
     *
     * @ORM\Column(name="confirmation_token", type="string", length=180)
     */
     ...
     * Add circleUser
     *
     * @param \AppBundle\Circle_user $circleUser
     *
     * @return User
     */
    public function addCircleUser(\AppBundle\Circle_user $circleUser)
    {
     ...
     * @param \AppBundle\Circle_user $circleUser
     */
    public function removeCircleUser(\AppBundle\Circle_user $circleUser)
    {
     ...
     * Add dataApp
     *
     * @param \AppBundle\Data_app $dataApp
     *
     * @return User
     */
    public function addDataApp(\AppBundle\Data_app $dataApp)
    {
     ...
     * @param \AppBundle\Data_app $dataApp
     */
    public function removeDataApp(\AppBundle\Data_app $dataApp)
    {
